...
const CustomerTicket = ({ pending, inProgress, resolved, onStart, onComplete, status })=> {
  ...
  return (
    <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className="md:w-[1100px] col-span-1 md:col-span-2 bg-white p-2 rounded-xl shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {pending.map(ticket => (
            <div
              ...
              className="cursor-pointer bg-gray-50 p-4 rounded-lg border hover:shadow-md transition"
      ...
      <div className="bg-white p-6 rounded-xl w-full mx-auto md:max-w-[350px] md:ml-30 shadow">
        ...
        {inProgress.length === 0 ? (
          ...
          <div className="space-y-3 md:mb-4">
            {inProgress.map(t => (
              <div key={t.id} className="bg-gray-50 p-4 rounded-lg shadow-sm border">
